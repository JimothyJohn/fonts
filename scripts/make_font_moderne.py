...
from fontgen.moderne import make_glyphs
from fontgen.primitives import finalize, rect

FAMILY = "Aperture Moderne"
STYLE = "Regular"
OUT = "out/aperture-moderne.ttf"

# Tighter than the sans' 70: display didones are set close, and the
# wide serif slabs already push letters apart optically.
SIDE_BEARING = 52
